...
from combat_sim.env import (
    ...
    ACT_SWAP_WEAPON, ACT_SIGIL_0, ACT_FACE_TARGET, ACT_FACE_AWAY,
    ACT_LOOK_DOWN_SELF, ACT_FACE_MOVEMENT, ACT_TARGET_0,
)
...
ACTION_NAMES = {
    ...
    ACT_FACE_TARGET: "FACE_TGT", ACT_FACE_AWAY: "FACE_AWAY",
    ACT_LOOK_DOWN_SELF: "LOOK_DN", ACT_FACE_MOVEMENT: "FACE_MOVE",
}
for i in range(12):
