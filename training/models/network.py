...
from ..config import (
    SELF_STATE_DIM, ENTITY_FEATURE_DIM, COMBAT_CTX_DIM, SIGIL_STATE_DIM,
    ENV_STATE_DIM, NUM_ACTIONS, MAX_ENTITIES,
    ENTITY_EMBED_DIM, ATTENTION_HEADS, ATTENTION_LAYERS, HIDDEN_DIM, GRU_HIDDEN_DIM,
)
